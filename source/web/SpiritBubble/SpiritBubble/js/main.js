...
function OnGameLaunch() {
    ...
    g_Engine.AddState(new StoryState_3);
    g_Engine.AddState(new StoryState_4);
    g_Engine.AddState(new StoryState_5);
    g_Engine.AddState(new StoryState_6);
    g_Engine.AddState(new EndStory);
