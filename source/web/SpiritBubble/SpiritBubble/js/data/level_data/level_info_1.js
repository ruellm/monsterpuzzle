...
function LoadLevels_1() {
    ...
    //--------------- level 9 -------------------------------------
    var level = new LevelBase();
    level.type = LEVEL_TYPE_CLEAR_ALL | LEVEL_TYPE_NO_SIGHT;

    level.description = new Array();
    level.description.push("Clear all bubbles to complete");
    level.description.push("the level!");
    level.description.push("This level has no sight guide.");
    level.max_bubble_count = 60;
    level.starCount = 0;
    level.tip.push("LINE GUIDE is disabled!");
    level.tip.push("Good Luck!");
    ...
    //--------------- level 11 -------------------------------------
    var level = new LevelBase();
    level.type = LEVEL_TYPE_OBSTACLE | LEVEL_TYPE_CLEAR_ALL | LEVEL_TYPE_PREDEFINE_BUBBLES | LEVEL_TYPE_NO_SIGHT;
    ...
    level.tip.push("This is a ONE SHOT-NO GUIDE level");
    level.tip.push("Good Luck!");
    ...
    InitFieldTemplate(level.bubbleMap);
    GenerateTrianglePattern(5, 6, 4, level.bubbleMap, param);
  ...
  //  level.tip.push("Watch out for the moving obstacle!");
	...
	level.bubbleMap = new Array();
    InitFieldTemplate(level.bubbleMap);
    GenerateRect(10, 5, level.bubbleMap, param);
    ...
    InitFieldTemplate(level.bubbleMap);
	 ...
	 var loc = 1;
    for (var i = 0; i < 6; i++) {
        GenerateSlantPattern(loc, 1, 6, i >=3, level.bubbleMap, param);
        loc += 3;
    }
	...
	var loc = 1;
    for (var i = 0; i < 8; i++) {
        GenerateBranchSingle(loc, 1, 6, level.bubbleMap, param);
        loc += 2;
    }
	...
	//--------------- level 94 -------------------------------------
	var level = new LevelBase();
    level.type = LEVEL_TYPE_OBSTACLE | LEVEL_TYPE_SURVIVAL_MODE | LEVEL_TYPE_TIMER | LEVEL_TYPE_NO_SIGHT;
	...
	//--------------- level 95 -------------------------------------
	var level = new LevelBase();
    level.type = LEVEL_TYPE_CLEAR_BANK | LEVEL_TYPE_NO_SIGHT | LEVEL_TYPE_OBSTACLE;
	...
	//--------------- level 96 -------------------------------------
	var level = new LevelBase();
    level.type = LEVEL_TYPE_CLEAR_ALL | LEVEL_TYPE_TIMER | LEVEL_TYPE_NO_SIGHT;
    ...
    var param = new GenerateParam();
    param.gray_bubble_pct = 2;
    param.blankpct = 2;

    level.bubbleMap = new Array();
    InitFieldTemplate(level.bubbleMap);
    GenerateRect(FIELD_WIDTH, 6, level.bubbleMap, param);
	...
	//--------------- level 97 -------------------------------------
	var level = new LevelBase();
    level.type = LEVEL_TYPE_TARGET_SCORE | LEVEL_TYPE_TIMER | LEVEL_TYPE_NO_SIGHT;
    ...
    level.description = new Array();
    level.description.push("Clean the field!");
    level.description.push("You are almost finish");
    level.description.push("with the game!");
    level.max_bubble_count = 50;
    level.bg_type = 2;
    level.tip.push("You are almost there,");
    level.tip.push("Play a full field");
    level.tip.push("to finish the game!");

    var param = new GenerateParam();
    param.gray_bubble_pct = 3;
    param.blankpct = 2;
    level.bubbleMap = new Array();
    InitFieldTemplate(level.bubbleMap);

    GenerateRect(FIELD_WIDTH, 10, level.bubbleMap, param);
    ...
    //--------------- level 99 -------------------------------------
    var level = new LevelBase();
    level.type = LEVEL_TYPE_TARGET_SCORE | LEVEL_TYPE_NO_SIGHT;

    level.max_bubble_count = 100;
    level.starCount = 0;
    level.bg_type = 1;
    level.scoreTarget = 3000;

    level.description = new Array();
    level.description.push("Target Score: Get a minimum of " + level.scoreTarget);
    level.description.push("score to complete the level.");
    level.description.push("You are given 100 bubbles!");

    level.tip.push("Complete the level by ");
    level.tip.push("reaching " + level.scoreTarget + " points");
    level.tip.push("Be Creative!");
    ...
    level.description = new Array();
    level.description.push("Survive the game in 3 minutes");
    level.max_bubble_count = 30;
    level.bubbleMap = new Array();
    level.coins_requirement = 400;
    level.barY = 340;
    level.isBarMoving = true;
    level.bg_type = 3;
    level.timerMax = 180;
